...
const Values = () => {
  ...
  return (
    <>
      <section>
        <div className='max-w-[1400px] ms-auto px-10 py-20'> 
...
const value=[
  {
    id:1,
    title:'Trust',
    para: 'Is is a long established fact that a reader will be distracted by the readable.',
    icon: <FaHeart/>
  },
  {
    id:2,
    title: 'Always Fresh',
    para: 'It is a long extablished fact that a reader will be distracted by the ',
    icon:<FaLeaf/>
  },
  {
    id:3,
